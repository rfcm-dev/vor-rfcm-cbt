...
function TakeExamInner() {
  ...
  if (submitted) {
    return (
      <main className="min-h-screen bg-rfcm-cream flex items-center justify-center p-4 text-center">
        <div className="bg-white/80 backdrop-blur-sm border border-rfcm-yellow-soft rounded-3xl shadow-xl p-10 max-w-sm">
  ...
  if (submitError) {
    return (
      <main className="min-h-screen bg-rfcm-cream flex items-center justify-center p-4 text-center">
        <div className="bg-white/80 backdrop-blur-sm border border-rfcm-red rounded-3xl shadow-xl p-10 max-w-sm">
  ...
  return (
    <main className="min-h-screen bg-rfcm-cream">
      {!online && (
        <div className="bg-rfcm-red text-white text-sm text-center py-3">
